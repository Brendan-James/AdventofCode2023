import copy
rules = """bcj{s>2236:A,s<1879:A,x<3217:R,R}
...
pbx{s>3731:R,R}""".split("\n")

objects = """{x=1272,m=2035,a=996,s=123}
...
{x=1144,m=2008,a=3108,s=645}""".split("\n")

rules2 = """px{a<2006:qkq,m>2090:A,rfg}
pv{a>1716:R,A}
lnx{m>1548:A,A}
...
objects2 = """{x=787,m=2655,a=1222,s=2876}
